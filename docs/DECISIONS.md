...
| O-003 | SHA-256 IDs and PureEd25519, with a replaceable crypto provider | Authorized for Phase 14 Blocks 1–4; canonical 32-byte keys, 64-byte R||S signatures, strict RFC 8032 acceptance, isolated public-domain provider, explicit authority evaluation, genesis-root grant provenance, and deterministic grant revocation are qualified |
